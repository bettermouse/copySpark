...
//import org.apache.spark.deploy.config
...
//  extends Logging {
//
//  private val blacklistTimeoutMillis = "1h"//BlacklistTracker.getBlacklistTimeout(sparkConf)
//
...
//  * FailureTracker负责分别跟踪每个主机和所有主机的执行器故障。
// */
//private[spark] class FailureTracker(
//    sparkConf: SparkConf,
//    val clock: Clock = new SystemClock) extends Logging {
//  // 执行者失败有效期间隔
//  private val executorFailuresValidityInterval = -1L
